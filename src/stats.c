...
int main (){
	...
	display_window* quit_window = display_create_window(EXIT, false, "w1/3:h1/3:w1/3:6");
	...
	display_window* yes_window = display_create_window(EXIT, true, "w1/2-4:h1/3+4:3:1");
	...
	display_window* no_window = display_create_window(EXIT, true, "w1/2+1:h1/3+4:2:1");
